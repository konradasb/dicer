...
#   curl -fsSL https://raw.githubusercontent.com/dicer-sh/dicer/main/scripts/install.sh | bash -s -- --ref v0.2.0
#

set -e

REPO_URL="https://github.com/dicer-sh/dicer.git"
...
Examples:
  ...
  curl -fsSL https://raw.githubusercontent.com/dicer-sh/dicer/main/scripts/install.sh | bash -s -- --ref my-feature-branch
EOF
}
...
Documentation=https://github.com/dicer-sh/dicer
...
case "$ARCH" in
amd64)
  echo "  dicer kernel import cloud-hypervisor-6-12-amd64 \\"
  echo "    --arch x86_64 --url https://github.com/kernel/linux/releases/download/ch-6.12.8-kernel-1.4-202602101/vmlinux-x86_64"
  KERNEL_NAME="cloud-hypervisor-6-12-amd64"
  ;;
arm64)
  echo "  dicer kernel import cloud-hypervisor-6-12-arm64 \\"
  echo "    --arch aarch64 --url https://github.com/kernel/linux/releases/download/ch-6.12.8-kernel-1.4-202602101/Image-arm64"
  KERNEL_NAME="cloud-hypervisor-6-12-arm64"
  ;;
esac
echo ""
