...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/dicer-sh/dicer/main/scripts/uninstall.sh | bash
#   curl -fsSL https://raw.githubusercontent.com/dicer-sh/dicer/main/scripts/uninstall.sh | bash -s -- --purge
#
