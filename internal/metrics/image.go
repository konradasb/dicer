...
// RecordImagePull records a pull that went to a registry: how it ended, how
// long it took, and the compressed bytes it downloaded. An image served from
// the local store is a cache hit rather than a pull, and is recorded by
// RecordImageCacheLookup.
