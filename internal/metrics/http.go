...
//
// Only the metrics registered here are served: the default registry is not
// consulted, so a dependency that registers metrics behind our back does not
// silently appear on this daemon's endpoint.
