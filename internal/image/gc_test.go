...
func usedAgo(digest string, d time.Duration) *dicer.Image {
	return &dicer.Image{Name: "img-" + digest, Digest: digest, LastUsedAt: gcNow.Add(-d), SizeBytes: 100}
}

func digests(images []*dicer.Image) []string {
