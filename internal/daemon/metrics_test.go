...
func TestServeMetricsServesMetricsPath(t *testing.T) {
	d := newTestDaemon(t, MetricsConfig{Enable: true, Listen: "127.0.0.1:0"})
...
func TestServeMetricsDisabledServesNothing(t *testing.T) {
	d := newTestDaemon(t, MetricsConfig{Listen: "127.0.0.1:0"})
