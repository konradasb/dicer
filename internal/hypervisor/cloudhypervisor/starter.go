...
//
// The console argument is unused: a Cloud Hypervisor snapshot carries the
// VM's whole configuration, the console file included, so a restored guest
// keeps writing where it wrote before.
