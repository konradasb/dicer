...
// PruneCache drops everything in the layout cache that is not one of the
// given images, and returns the bytes it reclaimed.
//
// The cache holds the compressed layers a pull downloaded. Nothing boots
// from it -- the bootable disk is built during the pull and stands alone --
// so an entry left here only saves downloading that image again.
