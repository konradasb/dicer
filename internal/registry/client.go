...
// imageRef's repository into the local OCI layout cache. The caller must
// hold layoutMu.
//
// It is fetched by digest rather than by imageRef's tag: the tag may have
// moved since it was resolved, and what is stored under layoutTag has to be
// the image the digest names.
