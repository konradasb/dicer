...
func TestVolumeOutlivesItsInstance(t *testing.T) {
	...
	env.createInstance(t, writer, "--volume", volume+":/mnt/data")
	...
	env.createInstance(t, reader, "--volume", volume+":/mnt/data")
...
func TestVolumeSurvivesItsInstance(t *testing.T) {
	...
	env.createInstance(t, instance, "--volume", volume+":/mnt/data")
