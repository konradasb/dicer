...
// already gone, which is the normal case when a test deleted it itself. The
// daemon names a missing resource `no instance "web"`, which the CLI prints
// after "Error: ".
func isNotFound(err error) bool {
	return err != nil && strings.Contains(err.Error(), "Error: no ")
}
