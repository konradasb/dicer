...
title: "dicer network allocation"
description: "Inspect the addresses assigned on a network"
---

Inspect the addresses assigned on a network

```
dicer network allocation [flags]
```
