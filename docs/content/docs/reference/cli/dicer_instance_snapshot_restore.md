...
title: "dicer instance snapshot restore"
description: "Restore a stopped instance from a snapshot and resume it"
---

Restore a stopped instance from a snapshot and resume it

### Synopsis

Puts a stopped instance back to the moment the snapshot was taken and
resumes it. Anything written to its disk since is discarded.

```
dicer instance snapshot restore INSTANCE NAME [flags]
```
