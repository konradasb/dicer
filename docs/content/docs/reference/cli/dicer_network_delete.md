...
title: "dicer network delete"
description: "Delete one or more networks no instance uses"
---

Delete one or more networks no instance uses

```
dicer network delete NAME... [flags]
```
