...
title: "dicer kernel delete"
description: "Delete one or more kernels no instance uses"
---

Delete one or more kernels no instance uses

```
dicer kernel delete NAME... [flags]
```
